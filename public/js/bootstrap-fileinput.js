...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <span class="kv-zoom-title" style="color: lightgray"></span>\n' +
                '      <div class="kv-zoom-actions" style="color: white">{toggleheader}{fullscreen}{borderless}{close}</div>\n' +
                '    </div>\n' +
            ...
            self.defaults = {
                ...
                previewSettingsSmall: {
                    image: {width: "250px", height: "auto", 'max-width': "100%", 'max-height': "100%"},
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-kv btn-outline-danger btn-outline-danger',
                    removeErrorClass: 'btn btn-kv btn-danger',
                    removeTitle: 'Remover archivo',
                    uploadIcon: '<i class="fas fa-upload"></i>',
                    uploadClass: 'btn btn-kv btn-outline-success btn-outline-success',
                    uploadTitle: 'Subir archivo',
                    uploadRetryIcon: '<i class="fas fa-repeat"></i>',
                    uploadRetryTitle: 'Reintentar subida',
                    downloadIcon: '<i class="fas fa-download"></i>',
                    downloadClass: 'btn btn-kv btn-outline-dark btn-outline-dark',
                    downloadTitle: 'Descargar archivo',
                    zoomIcon: '<i class="fas fa-search-plus"></i>',
                    zoomClass: 'btn btn-kv btn-outline-dark btn-outline-dark',
                    ...
                    indicatorError: '<i class="fas fa-exclamation-triangle text-danger"></i>',
                    indicatorLoading: '<i class="fas  fa-hourglass text-muted"></i>',
                    indicatorNewTitle: 'Aún no subida',
                    indicatorSuccessTitle: 'Subida',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            borderless: '<i class="fas  fa-compress"></i>',
            close: '<i class="fas  fa-times"></i>'
        },
        previewZoomButtonClasses: {
            prev: 'btn btn-navigate',
            next: 'btn btn-navigate',
            toggleheader: 'btn btn-kv btn-outline-light btn-outline-secondary',
            fullscreen: 'btn btn-kv btn-outline-light btn-outline-secondary',
            borderless: 'btn btn-kv btn-outline-light btn-outline-secondary',
            close: 'btn btn-kv btn-outline-light btn-outline-secondary'
        },
    ...
    $.fn.fileinputLocales.es = {
        ...
        cancelTitle: 'Abortar subida de archivos',
        uploadLabel: 'Subir',
        ...
        msgFileRequired: 'Tu debes seleccionar un archivo para subir.',
        msgSizeTooSmall: 'Archivo "{name}" (<b>{size} KB</b>) es demasiado pequeño y debe ser mayor a <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño de archivo seleccionado que es <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debes seleccionar al menos <b>{n}</b> {files} para subir.',
        msgFilesTooMany: 'Numero de archivos seleccionados <b>({n})</b> excede el máximo permitido de <b>{m}</b>.',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'Restricciones de seguridad no permiten leer el archivo "{name}".',
        msgFileNotReadable: 'Archivo "{name}" no es legible.',
        msgFilePreviewAborted: 'Vista previa abortada a "{name}".',
        msgFilePreviewError: 'Ocurrió un error al cargar el achivo "{name}".',
        msgInvalidFileName: 'Inválidos o formatos de archivo no permitidos "{name}".',
        msgInvalidFileType: 'Tipo archivo invalido para "{name}". Solo "{types}" están permitidos.',
        msgInvalidFileExtension: 'Extensión de archivo no permitido "{name}". Solo "{extensions}" archivos permitidos.',
        msgFileTypes: {
            'image': 'imagen',
            'html': 'HTML',
            'text': 'texto',
        ...
        msgUploadEnd: 'Hecho',
        msgUploadEmpty: 'Información no valida para la subida.',
        msgUploadError: 'Error',
        msgValidationError: 'Error de validación',
        msgLoading: 'Cargando archivo {index} de {files} &hellip;',
        msgProgress: 'Cargando {index} de {files} - {name} - {percent}% completado.',
        msgSelected: '{n} {files} seleccionados',
        msgFoldersNotAllowed: 'Arrastra & deja caer solamente! {n} carpeta(s) fueron omitidas.',
        msgImageWidthSmall: 'Ancho del archivo de imagen "{name}" debe ser de al menos {size} px.',
        msgImageHeightSmall: 'Altura del archivo de imagen "{name}" debe ser de al menos {size} px.',
        msgImageWidthLarge: 'Ancho del archivo de imagen "{name}" no puede exceder a {size} px.',
        msgImageHeightLarge: 'Altura del archivo de imagen "{name}" no puede acceder a {size} px.',
        msgImageResizeError: 'No se puede acceder a las dimensiones de la imagen para redimensionarla.',
        msgImageResizeException: 'Error mientras se redimensionaba la imagen.<pre>{errors}</pre>',
        msgAjaxError: '¡Ups algo ocurrió mal en la ! {operation} operación. Por favor intenta más tarde!',
        msgAjaxProgressError: '{operation} fallida',
        ajaxOperations: {
            deleteThumb: 'archivo borrado',
            uploadThumb: 'archivo subido',
            uploadBatch: 'batch de archivo subido',
            uploadExtra: 'información del formulario subida'
        },
        dropZoneTitle: 'Arrasta & suelta archivos aquí &hellip;',
        dropZoneClickTitle: '<br>(or click to select {files})',
        previewZoomButtonTitles: {
            prev: 'Ver archivo anterior',
            next: 'Ver archivo siguiente',
            toggleheader: 'Ocultar encabezado',
