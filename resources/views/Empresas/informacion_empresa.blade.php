    ...
    <div class="container-fluid">
        ...
        <div class="row my-2">
            <div class="col-lg-3 order-lg-1 text-center">
                ...
                <h4 class="mt-2">{{$empresa->name}}</h4>
                <h5 class="text-muted"><span class="fas fa-map-marker-alt"
                                             style="color: red"></span> {{$empresa->direccion}}</h5>
                ...
                <div class="tab-content py-4">
                    <div class="tab-pane active" id="profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h5 class="mt-2"><span class="fab fa-clock-o float-right"></span> Recent Activity</h5>
